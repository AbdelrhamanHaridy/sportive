        ...
        <ion-content class="overflow-auto">
            <div class="flex flex-col justify-center items-center mt-2">
                ...
                <div class="text-center">
                    ...
                    <ion-card-subtitle>{{state.tasksVolleyball.length}} Appointment</ion-card-subtitle>
                </div>
            </div>
...
export default defineComponent({
    ...
    setup(){
        ...
        tasksVolleyball: computed(() => {
          return store.getters.tasksByCategory('Volleyball')
        }),
        today: computed(() => {
            return store.getters.today(state.tasksVolleyball);
        }),
        late: computed(() => {
            return store.getters.late(state.tasksVolleyball);
        }),
        later: computed(() => {
            return store.getters.later(state.tasksVolleyball);
        }),
        done: computed(() => {
            return store.getters.done(state.tasksVolleyball);
        })
      }); 
      function getTasksVolleyball() {
      ...
      onMounted(() => {
        ...
        return{
            store,state,getTasksVolleyball,notDoneTask,doneTask,isOpenNewTask,deleteTask,
